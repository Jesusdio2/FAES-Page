...
// Inicializa Supabase con opciones seguras para Render
let supabase = null
try {
  supabase = createClient(supabaseUrl, supabaseKey, {
    auth: {
      storage: window.sessionStorage,   // evita el bloqueo de localStorage
      autoRefreshToken: false,          // no intenta refrescar tokens automáticamente
      persistSession: false             // no guarda sesión persistente
    }
  })
} catch (err) {
